...
import uru from "../../assets/images/uru.png";
            ...
            <div className="container my-5">
                <div className="row pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border">
                    <div className="col-lg-4 p-0 overflow-hidden shadow">
                        <img src={uru} className="rounded-lg-3" alt="" width="400" height='250'/>
                    </div>
                    ...
                    <div className="col-lg-7 offset-lg-1 p-3 p-lg-5 pt-lg-3">
                        ...
                        <p className="lead text-end" style={{ color: '#1a659e' }}>URU is an economic and social empowerment application that builds a connection between child and behavior therapist. Built alongside Luis Arnaut, Nell-E Medina, and Brad Smith.</p>
                        <div className="d-grid gap-2 d-md-flex justify-content-md-end mb-4 mb-lg-3">
                            <a href="https://uru.herokuapp.com/" target="_blank" rel="noopener noreferrer" type="button" className="btn btn-lg px-4 me-md-2 fw-bold" style={{ background: '#ff6b35' }}><span style={{ color: '#ffffff' }}>Check It Out</span></a>
                        </div>
                    </div>
